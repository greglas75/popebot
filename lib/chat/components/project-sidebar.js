    ...
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("span", { className: "flex-1 truncate text-left", children: project.name }),
...
function ProjectSidebar({ user }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    projects.length === 0 && /* @__PURE__ */ jsx(SidebarGroup, { children: /* @__PURE__ */ jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsx("p", { className: "px-4 py-2 text-sm text-muted-foreground", children: "No projects yet." }) }) }),
