...
import { listContainers, tailContainerLogs, getContainerStats, DockerFrameParser } from '../tools/docker.js';
      ...
      function startTailing(containerName) {
        ...
        (async () => {
          try {
            ...
            const frameParser = new DockerFrameParser();
            let stdoutBuf = '';
            let stderrBuf = '';
