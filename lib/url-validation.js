 ...
 * Blocks private IP ranges (IPv4, IPv6, IPv4-mapped IPv6), localhost, and
 * link-local / unique-local IPv6 patterns on the hostname.
 *
 * Resolves DNS (A + AAAA) so hostnames that point at private addresses are rejected.
 *
 ...
 * @throws {Error} If the URL is invalid, uses a non-HTTP(S) protocol, or targets a private network
 */
