...
describe('getCustomProviders', () => {
  ...
  it('skips corrupted provider rows without crashing and logs warning', () => {
    ...
    expect(console.warn).toHaveBeenCalledWith(
      expect.stringContaining('failed to decrypt provider "bad"'),
      expect.any(String),
    );
  });
});
...
describe('getCustomProvider', () => {
  ...
  it('returns null when provider data is corrupted and logs warning', () => {
